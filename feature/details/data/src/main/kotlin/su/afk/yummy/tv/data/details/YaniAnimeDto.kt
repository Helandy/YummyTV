...
data class YaniAnimeDetailsDto(
    val response: YaniAnimeResponseDto = YaniAnimeResponseDto(),
)
...
@Serializable
data class YaniViewingOrderDataDto(
...
@Serializable
data class YaniAnimeVideosDto(
    val response: List<YaniAnimeVideoDto> = emptyList(),
)
...
@Serializable
data class YaniRecommendationsDto(
    val response: List<YaniRecommendationItemDto> = emptyList(),
)
