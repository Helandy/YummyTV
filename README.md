...
YummyTV умеет работать с аккаунтом:

- вход по email или никнейму и паролю;
- обработка капчи прямо в приложении, если сервис её запросит;
- профиль, статистика и уведомления;
- чтение и обновление списков пользователя;
- синхронизация просмотренного, оценок, избранного и подписок;
- удаление элементов из списков и прогресса просмотра.

Локальная библиотека и прогресс остаются на устройстве даже после выхода из аккаунта.
