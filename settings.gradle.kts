...
include(":core:deeplink:api")
include(":core:model")
include(":core:common")
include(":core:error")
include(":core:error:api")
include(":core:mvi")
...
include(":feature:update:api")
include(":feature:update:domain")
include(":feature:update:data")
include(":feature:update:presentation")
include(":feature:update:ui")
